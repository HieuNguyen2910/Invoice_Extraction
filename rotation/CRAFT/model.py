...
model_urls = {
    'vgg16_bn': r'Receipt-Information-Extraction-main/Receipt-Information-Extraction-main/weights/vgg16_bn-6c64b313.pth'
}
...
def saveResult(img_file, img, boxes, dirname='./result/', verticals=None, texts=None):
    ...
    # result directory
    res_file = f'./{dirname}/text/{filename}.txt'
    res_img_file = f'./{dirname}/{filename}.jpg'
    if not os.path.exists(f'./{dirname}/text'):
        os.mkdir(f'./{dirname}/text')
